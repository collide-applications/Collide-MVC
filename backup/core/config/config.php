...
$reqIntLibs = array(	'log',
						'config',
						'load',
						'model',
						'view'
);
define( 'REQUIRED_INT_LIBS', 'return ' . var_export( $reqIntLibs, TRUE ) . ';' );
unset( $reqIntLibs );

// required external libraries
$reqExtLibs = array(	/*SMARTY_PATH . 'Smarty.class',
						DOCTRINE_PATH . 'Doctrine'*/
);
define( 'REQUIRED_EXT_LIBS', 'return ' . var_export( $reqExtLibs, TRUE ) . ';' );
unset( $reqExtLibs );
